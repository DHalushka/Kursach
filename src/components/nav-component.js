...
class NavComponent extends HTMLElement {
    ...
    connectedCallback(){
        ...
        this.searchType = this.getAttribute('type') ? this.getAttribute('type') : appConstants.search.types.post //если атрибут type не определен, то задаем по умолчанию post
        ...
        const {pathname: path} = new URL(window.location.href) //получаем текущий URL
